...
let $refs := $doc//*:encodingDesc/*:refsDecl[@n="CTS"]
let $repl := 
<refsDecl n="CTS">
        <cRefPattern n="segment" matchPattern="(\w+).(\w+).(\w+)" replacementPattern="#xpath(/tei:TEI/tei:text/tei:body/*[@n='$1']/*[@n='$2']/*[@n='$3'])">
          <p>This pointer pattern extracts @n value of segment.</p>
        </cRefPattern>
        <cRefPattern n="segment" matchPattern="(\w+).(\w+)" replacementPattern="#xpath(/tei:TEI/tei:text/tei:body/*[@n='$1']/*[@n='$2'])">
          <p>This pointer pattern extracts @n value of segment.</p>
        </cRefPattern>
        <cRefPattern n="segment" matchPattern="(\w+)" replacementPattern="#xpath(/tei:TEI/tei:text/tei:body/*[@n='$1'])">
          <p>This pointer pattern extracts @n value of segment.</p>
        </cRefPattern>
      </refsDecl>
(: let $single := ("head1", "cit1", "closer1") :)
for $d in $doc/*:TEI[*:text[not(*:group)]/*:body/*[@n]/*[@n]/*[@n]]
(: let $name := substring-after($d/@n, "div") :)
where $d
(: return replace node $refs with $repl :)
(: return replace value of node $d with "div" :)
